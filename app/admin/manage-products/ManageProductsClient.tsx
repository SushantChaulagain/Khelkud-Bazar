...
const ManageProductClient:React.FC<ManageProductsClientProps> = ({products}) => {
 ...
 if (products){
    ...
    const columns: GridColDef[] = [
        ...
        {field: 'price', headerName: 'Price(NPR)', width: 100, renderCell: (params) => {
        ...
        {field: 'inStock', headerName: 'InStock', width: 120, renderCell: (params) => {
            ...
            <Status text="in Stock" icon={MdDone} bg="bg-teal-100" color="text-teal-700"/> :
            <Status text="out of Stock" icon={MdClose} bg="bg-rose-100" color="text-rose-700"/>}</div>)
        }},
